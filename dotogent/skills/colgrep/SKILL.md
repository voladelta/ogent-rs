---
name: colgrep
description: Semantic code search CLI; use as the primary way for codebase exploration, symbol discovery, intent-based lookup, and general code search tasks.
---
